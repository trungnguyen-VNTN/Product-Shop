        ...
        try {
            ...
            if (session != null) {
                ...
                if (acc != null) {
                    ...
                    CartDAO cartDAO = new CartDAO(req.getServletContext());
                    CartDetailDAO detailDAO = new CartDetailDAO(req.getServletContext());

                    Cart cart = cartDAO.getCartByAccount(acc.getAccount());

                    if (cart != null) {
                        int count = detailDAO.countCartDetail(cart.getCartId());
