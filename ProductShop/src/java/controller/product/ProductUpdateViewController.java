 ...
 * @author PC
 */
public class ProductUpdateViewController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/views/private_views/update_product.jsp")
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ProductUpdateViewController.class.getName()).log(Level.SEVERE, null, ex);
