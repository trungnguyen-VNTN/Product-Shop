 ...
 * @author PC
 */
@WebServlet(name = "ProductFilterController", urlPatterns = {"/product_filter"})
public class ProductFilterController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Product> productList = productDAO.filterProducts(category, minPrice, maxPrice, discount, sort);
