                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="roleInSystem">
                                ...
                                <option value="1"
                                <c:if test="${(param.roleInSystem != null && param.roleInSystem == '1') 
                                              || (param.roleInSystem == null && acc.roleInSystem == 1)}">
                                      selected
                                </c:if>>
                                Administrator
                            </option>
                            ...
                            <option value="2"
                                    <c:if test="${(param.roleInSystem != null && param.roleInSystem == '2') 
                                                  || (param.roleInSystem == null && acc.roleInSystem == 2)}">
                                          selected
                                    </c:if>>
                                Staff
                            </option>
                            ...
                            <option value="0"
                                    <c:if test="${(param.roleInSystem != null && param.roleInSystem == '0') 
                                                  || (param.roleInSystem == null && acc.roleInSystem == 0)}">
                                          selected
                                    </c:if>>
                                Customer
                            </option>
